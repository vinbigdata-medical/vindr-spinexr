"""
from https://github.com/poodarchu/learn_aug_for_object_detection.numpy/blob/add-license-1/autoaugment_utils.py
"""

# Copyright 2019 Benjin Zhu
#
...
def _cutout_inside_bbox(image, bbox, pad_fraction):
  ...
  try:
    ...
    print(e)
    print("max x, max y, min x, min y", max_x, max_y, min_x, min_y)
    print("image size: h,w, box", image_height, image_width, bbox)
    raise ValueError("bbox error in _cutout_inside_bbox")
...
def bbox_cutout(image, bboxes, pad_fraction, replace_with_mean):
  ...
  def apply_bbox_cutout(image, bboxes, pad_fraction):
    ...
    try:
      ...
      print(e)
      raise ValueError("bbox error in apply_bbox_cutout")
